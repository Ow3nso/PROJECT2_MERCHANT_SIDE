...
class BillingCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Container(
        width: size.width,
        height: isPaySelected && type == TransactionType.topup ? 430 : 470,
          ...
          children: [
            ...
            Padding(
              ...
              child: DefaultButton(
                ...
                onTap: context.watch<AccountsController>().selectedMethod.keys.isNotEmpty ||
                    context.watch<AccountsController>().isChecked
                    ? () {
                  // context.read<AccountsController>().toggleChecked(true);
                  if (onConfirm != null) {
                    onConfirm!();
                  }
                }
