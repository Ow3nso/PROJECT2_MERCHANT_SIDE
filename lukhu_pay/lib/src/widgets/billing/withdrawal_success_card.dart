...
class WithdrawalSuccessCard extends StatelessWidget {
  const WithdrawalSuccessCard(
      {super.key,
        required this.title,
      ...
      child: ListView(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: StyleColors.lukhuError90,
            ...
            child: Text(
              ...
              style: TextStyle(
                color: StyleColors.lukhuError200,
                fontWeight: FontWeight.w600,
                fontSize: 32,
              ),
            ),
          ...
          DefaultButton(
            ...
            onTap: () {
              Navigator.pushNamed(context, Constants.sellPage);
            },
            width: size.width - 32,
            height: 40,
          ),
