      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          ...
          onNavigationRequest: (NavigationRequest request) {
            if (request.url.contains("processing")) {
              // Pop the WebView and return to the previous screen
              Navigator.of(context).pop(true); // You can pass true or any data if needed
