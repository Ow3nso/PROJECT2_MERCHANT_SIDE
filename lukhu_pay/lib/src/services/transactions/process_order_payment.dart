...
Future<void> processOrderPayment(BuildContext context) async {
  ...
  if (selectedMethods.isEmpty) {
    ...
    final walletId = context
        ...
        .wallet
        ?.shopId;
    final amount = context.read<CartController>().order?.price;
  ...
  if (payMethod.type == AccountType.mpesa) {
    ...
    final walletId = context
        ...
        .wallet
        ?.shopId;
    final amount = context.watch<CartController>().cartTotal.toStringAsFixed(0);
