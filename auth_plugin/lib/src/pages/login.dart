...
class _PasswordLoginPageState extends State<PasswordLoginPage> {
  ...
  void _navigateToAfterLogin() {
    ...
    if (navigationController.pendingRoute != null) {
      Navigator.pop(context);
      NavigationService.navigate(
        context, 
        navigationController.pendingRoute!,
        arguments: navigationController.pendingArguments,
        forever: true,
      );
      navigationController.pendingRoute = null;
      navigationController.pendingArguments = null;
      return;
    }
    ...
    if (_isDukastax()) {
      ...
      NavigationService.navigate(context, '/service');
    }
  }

  bool _isDukastax() {
    // Environment variable check
    const String appType = String.fromEnvironment('APP_TYPE', defaultValue: 'dukastax');
    return appType == 'dukastax';
  }
          ...
          child: Column(
            ...
            children: [
              ...
              AuthButton(
                ...
                actionDissabledColor: Color(0xffF38707).withOpacity(0.5),
