...
class ProductDetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool isDraft = product?.isAvailable == false;
    ...
    return Scaffold(
      appBar: LuhkuAppBar(
        ...
        title: Text(
          isDraft ? 'Draft Product' : 'Product Details',
          style: TextStyle(
                ...
                children: [
                  Padding(
                    ...
                    child: SaleCard(
                      ...
                      isDraft: isDraft, // Pass draft status
                    ),
                  ),
                  Padding(
                  ...
                  if (!isDraft) // Only show manage options for non-drafts
                    Padding(
                      padding: const EdgeInsets.only(top: 24),
      ...
      bottomSheet: product == null 
          ...
          : ProductBottomCard(
              ...
              secondaryLabel: isDraft ? 'Continue Editing' : 'Edit Product',
              onSecondary: () {
                context
