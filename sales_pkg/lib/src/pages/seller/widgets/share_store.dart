...
class ShareQrCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Get the web domain from UserRepository
    final qrData = context.read<UserRepository>().shop?.webDomain ?? '';
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            'Ask the customer to scan the QR code to view your Lukhu store or send them a link',
            textAlign: TextAlign.center,
            style: TextStyle(
              ...
              child: Container(
                ...
                child: Center(
                  child: QrImageView(
                    ...
                    data: qrData, // Use the web domain as QR data
                  ),
                ),
              ),
            ),
          ...
          DefaultButton(
            ...
            onTap: () {
              ...
              Share.share(qrData); // You can use the same qrData variable here
            },
